...
class BarData(Object):
    ...
    def __str__(self):
        return (
            "Date: %s, Open: %f, High: %f, Low: %f, Close: %f, Volume: %d, Average: %f, BarCount: %d"
            % (
                self.date,
                self.open,
                self.high,
...
class RealTimeBar(Object):
    ...
    def __str__(self):
        return (
            "Time: %d, Open: %f, High: %f, Low: %f, Close: %f, Volume: %d, WAP: %f, Count: %d"
            % (
                self.time,
                self.open_,
                self.high,
...
class HistoricalTickBidAsk(Object):
    ...
    def __str__(self):
        return (
            "Time: %d, TickAttriBidAsk: %s, PriceBid: %f, PriceAsk: %f, SizeBid: %d, SizeAsk: %d"
            % (
                self.time,
                self.tickAttribBidAsk,
                self.priceBid,
                self.priceAsk,
                self.sizeBid,
                self.sizeAsk,
...
class HistoricalTickLast(Object):
    ...
    def __str__(self):
        return (
            "Time: %d, TickAttribLast: %s, Price: %f, Size: %d, Exchange: %s, SpecialConditions: %s"
            % (
                self.time,
                self.tickAttribLast,
                self.price,
